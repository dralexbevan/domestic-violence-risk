...
| File | Description |
|---|---|
| `Bevan_Final_v10.ipynb` | Main analysis notebook (latest version) |
...
| `Bayes DF/Data Gathering Prompt.pages` | Prompt used to direct the LLM research agent that gathered the news-based dataset |
